...
import { LayoutDashboard, Users, LogOut, Loader2, Shield, Kanban, BarChart } from 'lucide-react';
...
export default function MainLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { name: 'Reports', href: '/manager', icon: BarChart },
    ];
        ...
        <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--color-bg-app)', color: 'var(--color-text-primary)' }}>
            ...
            <aside style={{
                ...
                <div style={{ marginBottom: '40px', display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{ width: '36px', height: '36px', background: 'var(--color-accent-primary)', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold', fontSize: '1.2rem' }}>C</div>
                    <span style={{ fontSize: '1.1rem', fontWeight: 700, color: 'white', letterSpacing: '-0.5px' }}>OnlyAI CRM</span>
                </div>
